<template>
  <div class="container mx-auto">
    ...
    <div class="lg:gap-2 lg:grid lg:grid-cols-3 group border-indigo-500 hover:bg-white">
      <div class="w-full rounded hover:scale-125"  v-for="image in images" :key="image.id">
